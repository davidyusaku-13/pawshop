  ...
  <main>
                ...
                <div class="card-body">
                  ...
                  <form action="addToCart.php" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="quantity" min="1" value="1" max="<?= $row['stok'] ?>" name="quantity">
                    </div>
    ...
    <div class="mx-auto d-flex justify-content-center" style="width: 15%;">
      ...
      <select id="itemsPerPage" class="" onchange="changeItemsPerPage()">
        <option value="4" <?php echo ($item_per_page == 4) ? 'selected' : ''; ?>>4</option>
        <option value="8" <?php echo ($item_per_page == 8) ? 'selected' : ''; ?>>8</option>
        <option value="12" <?php echo ($item_per_page == 12) ? 'selected' : ''; ?>>12</option>
      </select>
    </div>
                  ...
                  <tr>
                    ...
                    <td style="width: 6em;">
                      <form action="updateCart.php" method="POST">
                        ...
                        ?>
                            <input class="d-block form-control" type="number" name="quantity" max="<?= $row['stok'] ?>" value="<?= $item['quantity'] ?>" min="1">
                        <?php
                          }
                        }
                        ?>
