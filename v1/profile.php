...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
        ...
        <a href="./profile.php" class="w3-bar-item w3-button w3-blue w3-hover-teal">Profile</a>
    ...
    <div class="w3-container w3-margin-top">
        <div class="w3-card" style="width: 25%; margin-left: 37.5%;">
            ...
            ?>
                    <form class="w3-container" method="POST" action="update-profile.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $row['id'] ?>">
                        <p>
                            <label class="w3-text-teal"><b>Username</b></label>
                            <input class="w3-input w3-border w3-light-grey" type="text" name="username" value="<?= $row['username'] ?>" required>
                        </p>
                        <p>
                            <label class="w3-text-teal"><b>Old Password</b></label>
                            <input class="w3-input w3-border w3-light-grey" type="password" name="oldPassForm" required>
                        </p>
                        <p>
                            <label class="w3-text-teal"><b>Password</b></label>
                            <input class="w3-input w3-border w3-light-grey" type="password" name="newPassForm" required>
                        </p>
                        <p>
                            <label class="w3-text-teal"><b>Retype Password</b></label>
                            <input class="w3-input w3-border w3-light-grey" type="password" name="reNewPassForm" required>
                        </p>
                        <center>
                            <p>
