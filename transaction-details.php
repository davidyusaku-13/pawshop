...
<body>
  ...
  <div class="mt-3 container">
    <div class="row">
      <p><a class="btn btn-info" href="./transactions.php">
          << Transaksi</a>
      </p>
      <!-- TABLE -->
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
            ...
            $sql = "SELECT * FROM transaction_details trd JOIN product p ON trd.product_id=p.id WHERE transactions_id='$transID'";
            if (isset($_GET['s'])) {
              $search = $_GET['s'];
              $sql = "SELECT * FROM transaction_details WHERE nama_produk LIKE '%$search%'";
            }

            if (isset($_GET['k'])) {
              $kategori = $_GET['k'];
              $sql = "SELECT * FROM transaction_details WHERE category_id LIKE '%$kategori%'";
            }
